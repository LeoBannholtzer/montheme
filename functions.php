...
if ( ! function_exists( 'montheme_setup' ) ) :
	...
	function montheme_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'montheme_custom_background_args',
				array(
...
function montheme_scripts() {
	wp_enqueue_style( 'montheme-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'montheme-style', 'rtl', 'replace' );

	wp_enqueue_script( 'montheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
require get_template_directory() . '/framework/blog/blog.class.php';
require get_template_directory() . '/framework/blog/blog.model.php';