		...
		<section class="error-404 not-found">
			...
			<div class="page-content">
				<p><?php esc_html_e( 'Il semble que rien n\'ait été trouvé à cet endroit. Essayez peut-être l\'un des liens ci-dessous ou une recherche ?', 'montheme' ); ?></p>
					...
					$montheme_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'montheme' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$montheme_archive_content" );
